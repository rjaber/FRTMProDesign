...
public:
    ...
    glm::mat4 getSelectedCameraPerspectiveMatrix() const {
        return glm::perspective(glm::radians(static_cast<float>(getSelectedCameraFOV())),
    ...
    glm::mat4 getSelectedCameraViewProjectorMatrix() const {
        return glm::perspective(glm::radians(cameras_[selectedCamID_].FOV),
    ...
    glm::mat4 getCameraViewProjectorMatrix(int camID) const {
        return glm::perspective(glm::radians(cameras_[camID].FOV), cameras_[camID].aspectRatio, nearZ, farZ) *
    ...
    glm::mat4 getSelectedCamera180FOVProjectorMatrix() const {
        ...
        return glm::perspective(glm::radians(FOV_180), AP_180, nearZ, farZ) *
